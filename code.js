...
function buildScene() {
    ...
    p2.node = createNode({svg:"spaceship2", player:2, x:(window.innerWidth-margin-50), y:0});
    createNode({svg:"slime", player:0, x:150, y:150});
    createNode({svg:"slime", player:0, x:350, y:150});
    createNode({svg:"slime", player:0, x:550, y:150});
    createNode({svg:"slime", player:0, x:750, y:150});
    ...
    document.getElementsByClassName("spaceship2")[0].setAttribute("id","p2");
    assignlethrusters();
}
